...
int GetColorByRGB(const struct MyColorRef PixelRGB){
	...
	if(CompareRGB(PixelRGB, 214, 107, 5) || CompareRGB(PixelRGB, 219, 126, 39)){ // 亮黃
		if(Color == 0)
			Color = 1;
		else
			return 0;
	...
	if(CompareRGB(PixelRGB, 47, 107, 139)){ // 暗藍
		if(Color == 0)
			Color = 3;
		else
			return 0;
	...
	if(CompareRGB(PixelRGB, 201, 33, 245) || CompareRGB(PixelRGB, 200, 13, 245)){ // 亮紫
		if(Color == 0)
			Color = 4;
		else
			return 0;
	...
	if(CompareRGB(PixelRGB, 241, 105, 100) || CompareRGB(PixelRGB, 238, 69, 62) || CompareRGB(PixelRGB, 244, 136, 134)){ // 亮紅
		if(Color == 0)
			Color = 6;
		else
			return 0;
