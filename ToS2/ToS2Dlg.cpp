...
int GetColorByRGB(const struct MyColorRef PixelRGB){
	...
	if(CompareRGB(PixelRGB, 255, 149, 176) || CompareRGB(PixelRGB, 254, 129, 161) || CompareRGB(PixelRGB, 219, 123, 148)){ // 亮粉
		if(Color == 0)
			Color = 2;
		else
			return 0;
	...
	if(CompareRGB(PixelRGB, 254, 255, 255) || CompareRGB(PixelRGB, 214, 215, 215)){ // 亮藍
		if(Color == 0)
			Color = 3;
		else
			return 0;
	}
	if(CompareRGB(PixelRGB, 124, 0, 126) || CompareRGB(PixelRGB, 106, 20, 109)){ // 暗紫
		if(Color == 0)
			Color = 4;
		else
			return 0;
	}
	if(CompareRGB(PixelRGB, 201, 33, 245) || CompareRGB(PixelRGB, 200, 13, 245) || CompareRGB(PixelRGB, 180, 18, 217) || CompareRGB(PixelRGB, 167, 33, 197)){ // 亮紫
		if(Color == 0)
			Color = 4;
		else
			return 0;
